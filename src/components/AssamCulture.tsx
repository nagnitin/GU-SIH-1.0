      ...
      <div className="relative">
        ...
        <div className="w-64 h-64 relative">
          ...
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
            <div className="w-4 h-4 bg-green-500 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
          </div>
          ...
          <div className="absolute bottom-4 right-4">
            <div className="w-3 h-3 bg-green-600 rounded-full animate-pulse opacity-60" style={{ animationDelay: '1.5s' }}></div>
          </div>
        </div>
