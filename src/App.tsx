      ...
      <footer className="relative z-10 py-8 px-6 bg-transparent">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-900 font-serif font-semibold">
            © 2025 GUenARK 2025. Organized by Innovation, Incubation and Startup
            Cell, Gauhati University. Building Tomorrow at the Crossroads of
            Ideas, Investment & Governance. Honoring the spirit of Northeast
            India.
          </p>
        </div>
      </footer>
